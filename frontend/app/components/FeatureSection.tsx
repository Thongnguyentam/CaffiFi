...
function FeatureCard({ icon: Icon, title, description }) {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.95 }}
      className="relative overflow-hidden rounded-xl bg-gradient-to-br from-[#d4b37f]/10 to-[#8B4513]/10 p-px group"
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#d4b37f] to-[#8B4513] opacity-0 group-hover:opacity-30 transition-opacity duration-300 ease-in-out" />
